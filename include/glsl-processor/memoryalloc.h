...
#define alloc_memory(outPtr, numElems, elemSize) _gp_alloc_memory(MAKE_LOGCTX(), (outPtr), (numElems), (elemSize))
#define realloc_memory(inoutPtr, numElems, elemSize) _gp_realloc_memory(MAKE_LOGCTX(), (inoutPtr), (numElems), (elemSize))
#define free_memory(inoutPtr) _gp_free_memory(MAKE_LOGCTX(), (inoutPtr))
