...
Glsl-processor is written in pure C and weighs only about 2000 lines. Only
...
glsl-processor code. You can either just add all the files under src/ to your
program and build everything at once. Or, you can build glsl-processor as a
static library, using the provided Makefile / .vcxproj file. If you use your
own method, just make sure to build the glsl-processor code as C99, and make
sure to add the include/ directory to the list of include directories.
...
Support #include directives in some way.
